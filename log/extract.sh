...
grep -E "IP 192.168.10.17.24 > 192.168.10.202.$port:" total.log | grep -v mss | grep -v none | sed -e 's/,//g' -e 's/:/ /g' > data.activity
tcpdumpdiff -s $start_time data.activity > data.activity.log
